  ...
  (testing "should return winning pairs with counts, powerball is never counted, in order of counts largest to smallest"
    (let [combinations
      (count-pairs [[1 2 3 4 5 6]
                    [1 7 2 8 9 10]
                    [9 1 2 13 14 15]])]
      (is (= combinations [["1-2" 3] ["2-9" 2] ["1-9" 2] ["13-14" 1] ["2-4" 1] ["2-8" 1] ["1-14" 1] ["2-7" 1] ["1-5" 1]
        ["1-4" 1] ["1-8" 1] ["7-9" 1] ["2-5" 1] ["9-13" 1] ["3-4" 1] ["8-9" 1] ["7-8" 1] ["1-7" 1]
        ["3-5" 1] ["2-14" 1] ["1-3" 1] ["4-5" 1] ["2-13" 1] ["2-3" 1] ["9-14" 1] ["1-13" 1]])))))
...
(deftest test-coll->ints
  (testing "should convert all strings to integers"
    (let [coll (coll->ints [["1" "2" "3"] ["4" "5" "6"]])]
      (is (= [[1 2 3] [4 5 6]])))))
